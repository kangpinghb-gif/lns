...
class LNSOrchestrator:
    ...
    def _bazi_to_dict(self, bazi: BaZiOutput) -> dict:
        return {
            ...
            "hidden_stems": bazi.hidden_stems,
            "luck_cycles": [
                {
    ...
    def simulate(self, user_input, scenarios):
        ...
        for sc in scenarios:
            ...
            sc_result = self.full_analysis(user_input, target_time=target, age=age)
    ...
    def _bazi_to_dict_simple(self, bazi_data):
        return {
            ...
            "hidden_stems": bazi_data.get("hidden_stems", {}),
            "start_age": bazi_data.get("start_age", 0),
